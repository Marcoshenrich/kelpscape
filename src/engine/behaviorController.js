...
export default class BehaviorController {
    constructor(logic) {
        ...
        this.denizensSpawnInIncrements(this.algaeSpawnIncrement, "algaeCount", "algae", Algae, { clustersObj: this.logic.seaweedClusters })

        this.otterDiveIncrement = 10000
        this.denizensSpawnInIncrements(this.otterDiveIncrement, "otterCount", "otters", Otter)
