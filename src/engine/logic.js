...
export default class Logic {
    ...
    constructor(ctx, canvas, view) {
        ...
        // this.bass = this.tankPopulator(this.bassCount, Fish, "Bass")
        // this.bassBabies = this.tankPopulator(this.bassbabyCount, FishBaby, "bassBabies")
    ...
    spawnDenizen(parentDenizen) {
        switch(parentDenizen.constructor) {
            ...
            case GarabaldiBaby:
                ...
                this.garabaldi["Garabaldi" + this.garabaldiCount] = new Garabaldi(this.garabaldiCount, this.ctx, this.canvas, this.view, this, [parentDenizen.pos[0], parentDenizen.pos[1]])
                break
            case Crab:
    ...
    reAssignDataObjs() {
        this.predatorsWithMouthsArr = [...Object.values(this.garabaldiBabies),...Object.values(this.garabaldi), ...Object.values(this.sharks)]
    ...
    assignFoodWeb() {
        Garabaldi.prototype.preySpecies = [Algae]
        Garabaldi.prototype.preySpeciesArr = [this.algae]
        GarabaldiBaby.prototype.preySpecies = [Algae]
        GarabaldiBaby.prototype.preySpeciesArr = [this.algae]
        Shark.prototype.preySpecies = [Garabaldi, GarabaldiBaby]
        Shark.prototype.preySpeciesArr = [this.garabaldi, this.garabaldiBabies]
        Crab.prototype.preySpecies = [GarabaldiBaby]
        Crab.prototype.preySpeciesArr = [this.garabaldiBabies]
        Jellyfish.prototype.preySpecies = [GarabaldiBaby, Fishegg]
        Jellyfish.prototype.preySpeciesArr = [this.garabaldiBabies, this.eggs]
    ...
    fishFleeFromSharks() {
        let allFish = [...Object.values(this.garabaldi), ...Object.values(this.garabaldiBabies)]
